...
> Data Analyst - Report the attributes of attrition and what other patterns you can recognise related attrition. The results thus obtained will be used by the management to understand what changes they should make to their workplace, in order to get most of their employees to stay.

> Data Science - Model the probability of attrition using a logistic regression. The results thus obtained will be used by the management to understand what changes they should make to their workplace, in order to get most of their employees to stay.
...
1. Download the CSVs within the [Datasets](https://github.com/Fenty1738/HR-Analytics-1.git) folder into your directory
...
3. Create tables within your newly created database using the [SQL](https://github.com/Fenty1738/HR-Analytics-1.git.sql) file
